...
public class RedArmor extends Armor {
	...
	public RedArmor(Map<Language, String> name, GradeName[] grades, int lvl, Quality quality, boolean enchantable, boolean reinca, ArmorType type, String setCode, String iconPath, Calculable[] effects, Calculable[] bonusXP, Calculable[][] starEffects) {
