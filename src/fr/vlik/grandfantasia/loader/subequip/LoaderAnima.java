...
public class LoaderAnima extends LoaderTemplate {
	
	static Anima[] getAnima() {
		return Stream.of(new Anima[] { new Anima() }, getPurple(), getSanctuary(), getOrange()).flatMap(Stream::of).toArray(Anima[]::new);
	}
	
	private static Anima[] getPurple() {
		return new Anima[] {
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre transperçant"); put(Language.EN, "Piercing Forest Shard"); }}, Quality.PURPLE, "vio0", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre gardien"); put(Language.EN, "Guardian Forest Shard"); }}, Quality.PURPLE, "vio1", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre d'attaque"); put(Language.EN, "Assault Forest Shard"); }}, Quality.PURPLE, "vio2", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre de chasse"); put(Language.EN, "Hunting Forest Shard"); }}, Quality.PURPLE, "vio3", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 8),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre ésotérique"); put(Language.EN, "Arcane Forest Shard"); }}, Quality.PURPLE, "vio4", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 8),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre redoutable"); put(Language.EN, "Mighty Forest Shard"); }}, Quality.PURPLE, "vio5", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre embrasant"); put(Language.EN, "Blazing Forest Shard"); }}, Quality.PURPLE, "vio6", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre de dextérité"); put(Language.EN, "Dexterity Forest Shard"); }}, Quality.PURPLE, "vio7", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre renforçant"); put(Language.EN, "Hardening Forest Shard"); }}, Quality.PURPLE, "vio8", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
	...
	private static Anima[] getSanctuary() {
		return new Anima[] {
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima sylvestre d'Alice"); put(Language.EN, "Alice's Forest Shard"); }}, Quality.PURPLE, "sanctuary1", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 8),
			        new Effect(TypeEffect.DCCP, false, 1),
			        new Effect(TypeEffect.DCCM, false, 1),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Éclat du désert de Ronto"); put(Language.EN, "Ronto's Desert Shard"); }}, Quality.PURPLE, "sanctuary2", new MultiEffect(1, new Effect[][] {
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 3, true),
					new Effect(TypeEffect.AtkD, false, 3, true),
					new Effect(TypeEffect.DefP, false, 3, true),
					new Effect(TypeEffect.AtkM, false, 3, true),
					new Effect(TypeEffect.DefM, false, 3, true),
					new Effect(TypeEffect.Toucher, false, 8),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 7, true),
					new Effect(TypeEffect.AtkD, false, 7, true),
					new Effect(TypeEffect.DefP, false, 6, true),
					new Effect(TypeEffect.AtkM, false, 5, true),
					new Effect(TypeEffect.DefM, false, 5, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.DefP, false, 9, true),
					new Effect(TypeEffect.AtkM, false, 8, true),
					new Effect(TypeEffect.DefM, false, 7, true),
					new Effect(TypeEffect.Toucher, false, 8),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 13, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 16, true),
					new Effect(TypeEffect.AtkD, false, 16, true),
					new Effect(TypeEffect.DefP, false, 15, true),
					new Effect(TypeEffect.AtkM, false, 13, true),
					new Effect(TypeEffect.DefM, false, 12, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 19, true),
					new Effect(TypeEffect.AtkD, false, 19, true),
					new Effect(TypeEffect.DefP, false, 18, true),
					new Effect(TypeEffect.AtkM, false, 15, true),
					new Effect(TypeEffect.DefM, false, 14, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 22, true),
					new Effect(TypeEffect.AtkD, false, 22, true),
					new Effect(TypeEffect.DefP, false, 20, true),
					new Effect(TypeEffect.AtkM, false, 18, true),
					new Effect(TypeEffect.DefM, false, 16, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
					...
					new Effect(TypeEffect.DefP, false, 23, true),
					new Effect(TypeEffect.AtkM, false, 20, true),
					new Effect(TypeEffect.DefM, false, 19, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 28, true),
					new Effect(TypeEffect.AtkD, false, 28, true),
					new Effect(TypeEffect.DefP, false, 26, true),
					new Effect(TypeEffect.AtkM, false, 23, true),
					new Effect(TypeEffect.DefM, false, 21, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 32, true),
					new Effect(TypeEffect.AtkD, false, 32, true),
					new Effect(TypeEffect.DefP, false, 29, true),
					new Effect(TypeEffect.AtkM, false, 25, true),
					new Effect(TypeEffect.DefM, false, 23, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 35, true),
					new Effect(TypeEffect.AtkD, false, 35, true),
					new Effect(TypeEffect.DefP, false, 32, true),
					new Effect(TypeEffect.AtkM, false, 28, true),
					new Effect(TypeEffect.DefM, false, 26, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 41, true),
					new Effect(TypeEffect.AtkD, false, 41, true),
					new Effect(TypeEffect.DefP, false, 38, true),
					new Effect(TypeEffect.AtkM, false, 33, true),
					new Effect(TypeEffect.DefM, false, 30, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 44, true),
					new Effect(TypeEffect.AtkD, false, 44, true),
					new Effect(TypeEffect.DefP, false, 41, true),
					new Effect(TypeEffect.AtkM, false, 35, true),
					new Effect(TypeEffect.DefM, false, 32, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 47, true),
					new Effect(TypeEffect.AtkD, false, 47, true),
					new Effect(TypeEffect.DefP, false, 43, true),
					new Effect(TypeEffect.AtkM, false, 38, true),
					new Effect(TypeEffect.DefM, false, 35, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 1),
				},
				new Effect[] {
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 53, true),
					new Effect(TypeEffect.DefP, false, 49, true),
					new Effect(TypeEffect.AtkM, false, 43, true),
					new Effect(TypeEffect.DefM, false, 39, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 2),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 57, true),
					new Effect(TypeEffect.AtkD, false, 57, true),
					new Effect(TypeEffect.DefP, false, 52, true),
					new Effect(TypeEffect.AtkM, false, 45, true),
					new Effect(TypeEffect.DefM, false, 42, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 2),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 60, true),
					new Effect(TypeEffect.AtkD, false, 60, true),
					new Effect(TypeEffect.DefP, false, 55, true),
					new Effect(TypeEffect.AtkM, false, 48, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 66, true),
					new Effect(TypeEffect.AtkD, false, 66, true),
					new Effect(TypeEffect.DefP, false, 61, true),
					new Effect(TypeEffect.AtkM, false, 53, true),
					new Effect(TypeEffect.DefM, false, 49, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 2),
				},
				new Effect[] {
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 72, true),
					new Effect(TypeEffect.DefP, false, 66, true),
					new Effect(TypeEffect.AtkM, false, 58, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 78, true),
					new Effect(TypeEffect.AtkD, false, 78, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 82, true),
					new Effect(TypeEffect.AtkD, false, 82, true),
					new Effect(TypeEffect.DefP, false, 75, true),
					new Effect(TypeEffect.AtkM, false, 65, true),
					new Effect(TypeEffect.DefM, false, 60, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 85, true),
					new Effect(TypeEffect.AtkD, false, 85, true),
					new Effect(TypeEffect.DefP, false, 78, true),
					new Effect(TypeEffect.AtkM, false, 68, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 91, true),
					new Effect(TypeEffect.AtkD, false, 91, true),
					new Effect(TypeEffect.DefP, false, 84, true),
					new Effect(TypeEffect.AtkM, false, 73, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 97, true),
					new Effect(TypeEffect.AtkD, false, 97, true),
					new Effect(TypeEffect.DefP, false, 89, true),
					new Effect(TypeEffect.AtkM, false, 78, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 103, true),
					new Effect(TypeEffect.AtkD, false, 103, true),
					new Effect(TypeEffect.DefP, false, 95, true),
					new Effect(TypeEffect.AtkM, false, 83, true),
					new Effect(TypeEffect.DefM, false, 76, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 3),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 107, true),
					new Effect(TypeEffect.AtkD, false, 107, true),
					new Effect(TypeEffect.DefP, false, 98, true),
					new Effect(TypeEffect.AtkM, false, 85, true),
					new Effect(TypeEffect.DefM, false, 78, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 110, true),
					new Effect(TypeEffect.AtkD, false, 110, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkM, false, 93, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 122, true),
					new Effect(TypeEffect.AtkD, false, 122, true),
					new Effect(TypeEffect.DefP, false, 112, true),
					new Effect(TypeEffect.AtkM, false, 98, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 128, true),
					new Effect(TypeEffect.AtkD, false, 128, true),
					new Effect(TypeEffect.DefP, false, 118, true),
					new Effect(TypeEffect.AtkM, false, 103, true),
					new Effect(TypeEffect.DefM, false, 95, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 3),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 132, true),
					new Effect(TypeEffect.AtkD, false, 132, true),
					new Effect(TypeEffect.DefP, false, 121, true),
					new Effect(TypeEffect.AtkM, false, 105, true),
					new Effect(TypeEffect.DefM, false, 97, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 135, true),
					...
					new Effect(TypeEffect.DefM, false, 99, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 3),
				},
				new Effect[] {
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 141, true),
					new Effect(TypeEffect.AtkD, false, 141, true),
					new Effect(TypeEffect.DefP, false, 130, true),
					new Effect(TypeEffect.AtkM, false, 113, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 147, true),
					new Effect(TypeEffect.DefP, false, 135, true),
					new Effect(TypeEffect.AtkM, false, 118, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 153, true),
					new Effect(TypeEffect.AtkD, false, 153, true),
					new Effect(TypeEffect.DefP, false, 141, true),
					new Effect(TypeEffect.AtkM, false, 123, true),
					new Effect(TypeEffect.DefM, false, 113, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 3),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 157, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 160, true),
					new Effect(TypeEffect.AtkD, false, 160, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 166, true),
					new Effect(TypeEffect.AtkD, false, 166, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 172, true),
					new Effect(TypeEffect.DefP, false, 158, true),
					new Effect(TypeEffect.AtkM, false, 138, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 178, true),
					new Effect(TypeEffect.DefP, false, 164, true),
					new Effect(TypeEffect.AtkM, false, 143, true),
					new Effect(TypeEffect.DefM, false, 131, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 4),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 182, true),
					new Effect(TypeEffect.AtkD, false, 182, true),
					new Effect(TypeEffect.DefP, false, 167, true),
					new Effect(TypeEffect.AtkM, false, 145, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 185, true),
					new Effect(TypeEffect.AtkD, false, 185, true),
					new Effect(TypeEffect.DefP, false, 170, true),
					new Effect(TypeEffect.AtkM, false, 148, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 191, true),
					new Effect(TypeEffect.DefP, false, 176, true),
					new Effect(TypeEffect.AtkM, false, 153, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 197, true),
					new Effect(TypeEffect.AtkD, false, 197, true),
					new Effect(TypeEffect.DefP, false, 181, true),
					new Effect(TypeEffect.AtkM, false, 158, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkM, false, 163, true),
					new Effect(TypeEffect.DefM, false, 150, true),
					new Effect(TypeEffect.Toucher, false, 8),
					new Effect(TypeEffect.Parade, false, 4),
				},
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 207, true),
					new Effect(TypeEffect.AtkD, false, 207, true),
					new Effect(TypeEffect.DefP, false, 190, true),
					new Effect(TypeEffect.AtkM, false, 165, true),
					new Effect(TypeEffect.DefM, false, 152, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 210, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 216, true),
					new Effect(TypeEffect.AtkD, false, 216, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 222, true),
					new Effect(TypeEffect.AtkD, false, 222, true),
					new Effect(TypeEffect.DefP, false, 204, true),
					new Effect(TypeEffect.AtkM, false, 178, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 228, true),
					new Effect(TypeEffect.AtkD, false, 228, true),
					new Effect(TypeEffect.DefP, false, 210, true),
					new Effect(TypeEffect.AtkM, false, 183, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 232, true),
					new Effect(TypeEffect.DefP, false, 213, true),
					new Effect(TypeEffect.AtkM, false, 185, true),
					new Effect(TypeEffect.DefM, false, 170, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 235, true),
					new Effect(TypeEffect.AtkD, false, 235, true),
					new Effect(TypeEffect.DefP, false, 216, true),
					new Effect(TypeEffect.AtkM, false, 188, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 241, true),
					new Effect(TypeEffect.AtkD, false, 241, true),
					new Effect(TypeEffect.DefP, false, 222, true),
					new Effect(TypeEffect.AtkM, false, 193, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 247, true),
					new Effect(TypeEffect.AtkD, false, 247, true),
					new Effect(TypeEffect.DefP, false, 227, true),
					new Effect(TypeEffect.AtkM, false, 198, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 253, true),
					new Effect(TypeEffect.AtkD, false, 253, true),
					new Effect(TypeEffect.DefP, false, 233, true),
					new Effect(TypeEffect.AtkM, false, 203, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 257, true),
					new Effect(TypeEffect.DefP, false, 236, true),
					new Effect(TypeEffect.AtkM, false, 205, true),
					new Effect(TypeEffect.DefM, false, 189, true),
					new Effect(TypeEffect.Toucher, false, 8),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 260, true),
					new Effect(TypeEffect.AtkD, false, 260, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 266, true),
					new Effect(TypeEffect.AtkD, false, 266, true),
					new Effect(TypeEffect.DefP, false, 245, true),
					new Effect(TypeEffect.AtkM, false, 213, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 272, true),
					new Effect(TypeEffect.AtkD, false, 272, true),
					new Effect(TypeEffect.DefP, false, 250, true),
					new Effect(TypeEffect.AtkM, false, 218, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 278, true),
					new Effect(TypeEffect.AtkD, false, 278, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 285, true),
					new Effect(TypeEffect.AtkD, false, 285, true),
					new Effect(TypeEffect.DefP, false, 262, true),
					new Effect(TypeEffect.AtkM, false, 228, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 291, true),
					new Effect(TypeEffect.AtkD, false, 291, true),
					new Effect(TypeEffect.DefP, false, 268, true),
					new Effect(TypeEffect.AtkM, false, 233, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 297, true),
					new Effect(TypeEffect.AtkD, false, 297, true),
					new Effect(TypeEffect.DefP, false, 273, true),
					new Effect(TypeEffect.AtkM, false, 238, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 303, true),
					new Effect(TypeEffect.AtkD, false, 303, true),
					new Effect(TypeEffect.DefP, false, 279, true),
					new Effect(TypeEffect.AtkM, false, 243, true),
				...
				new Effect[] {
					...
					new Effect(TypeEffect.AtkD, false, 307, true),
					new Effect(TypeEffect.DefP, false, 282, true),
					new Effect(TypeEffect.AtkM, false, 245, true),
				...
				new Effect[] {
					new Effect(TypeEffect.Atk, false, 310, true),
					new Effect(TypeEffect.AtkD, false, 310, true),
					new Effect(TypeEffect.DefP, false, 285, true),
					new Effect(TypeEffect.AtkM, false, 248, true),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Fragment chevalier de Bodor"); put(Language.EN, ""); }}, Quality.PURPLE, "sanctuary3", new MultiEffect(1, new Effect[][] {
				new Effect[] {
				...
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 6),
					new Effect(TypeEffect.PeneP, false, 1.8),
					new Effect(TypeEffect.PeneM, false, 1.8),
				},
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 6),
				...
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 7),
					new Effect(TypeEffect.PeneP, false, 2.2),
					new Effect(TypeEffect.PeneM, false, 2.2),
				},
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 7),
					new Effect(TypeEffect.PeneP, false, 2.4),
					new Effect(TypeEffect.PeneM, false, 2.4),
				},
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 7),
					new Effect(TypeEffect.PeneP, false, 2.6),
					new Effect(TypeEffect.PeneM, false, 2.6),
				},
				new Effect[] {
					new Effect(TypeEffect.Toucher, false, 14),
					new Effect(TypeEffect.ESQ, false, 7),
					new Effect(TypeEffect.PeneP, false, 2.8),
					new Effect(TypeEffect.PeneM, false, 2.8),
				},
			})),
		};
	}
	...
	private static Anima[] getOrange() {
		return new Anima[] {
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Rétablissement"); put(Language.EN, "Anima Shard of Recovery"); }}, Quality.ORANGE, "ora0", new Calculable[] {
				new Effect(TypeEffect.Toucher, false, 8),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Rapidité"); put(Language.EN, "Anima Shard of Swiftness"); }}, Quality.ORANGE, "ora1", new Calculable[] {
				new Effect(TypeEffect.Toucher, false, 8),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Polyvalence"); put(Language.EN, "Anima Shard of Versatility"); }}, Quality.ORANGE, "ora2", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.FCE, false, 2, true),
			        new Effect(TypeEffect.VIT, false, 2, true),
			        new Effect(TypeEffect.INT, false, 2, true),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Sort"); put(Language.EN, "Anima Shard of Sorcery"); }}, Quality.ORANGE, "ora3", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 8),
			        new Effect(TypeEffect.DCCM, false, 1),
			    },
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima d'Exécution"); put(Language.EN, "Anima Shard of Assassination"); }}, Quality.ORANGE, "ora4", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 8),
			        new Effect(TypeEffect.DCCP, false, 1),
			    },
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Courage"); put(Language.EN, "Anima Shard of Fortitude"); }}, Quality.ORANGE, "ora5", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.DefP, false, 6, true),
			        new Effect(TypeEffect.DefM, false, 5, true),
			        new Effect(TypeEffect.Toucher, false, 8),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Discrétion"); put(Language.EN, "Anima Shard of Subtly"); }}, Quality.ORANGE, "ora6", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Toucher, false, 10),
			        new Effect(TypeEffect.ESQ, false, 2),
			    },
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima de Précision"); put(Language.EN, "Anima Shard of Truestrike"); }}, Quality.ORANGE, "ora7", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.Atk, false, 6, true),
			        new Effect(TypeEffect.AtkD, false, 6, true),
			        new Effect(TypeEffect.AtkM, false, 5, true),
			...
			new Anima(new EnumMap<Language, String>(Language.class) {{ put(Language.FR, "Anima multi-noyaux"); put(Language.EN, "Anima Shard of Alchemy"); }}, Quality.ORANGE, "ora8", new MultiEffect(1, new Calculable[][] {
			    new Calculable[] {
			        new Effect(TypeEffect.PM, false, 15, true),
